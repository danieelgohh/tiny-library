    ...
    <nav className="flex w-full px-5 py-2.5 items-center lg:max-h-35.5 ">
      <ul className="flex justify-between items-center w-full">
        ...
        <div className="flex gap-10 font-semibold font-primary text-[#606060]">
          ...
          <Link href="/about"><li className={`${pathname.startsWith("/about") ? "text-[#F77429] underline decoration-[#F77429]" : ""} underline-offset-8 hover:text-[#F77429]`}>{pathname === "/about/contact" ? "ABOUT:CONTACT" : "ABOUT"}</li></Link>
        </div>
      </ul>
    </nav>
  )
